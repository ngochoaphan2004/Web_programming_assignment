    ...
    return (
        <div className="font-sans  px-4 py-6">
            ...
            <div className="mb-8">
                ...
                >
                    <li className="text-sm"><a onClick={() => { setIsOpenBH1(prev => !prev) }}>Giày được bảo hành không</a>
                        {isOpenBH1 && (
                            <motion.div
                                initial={{
                                    opacity: 0,
                    ...
                    <li className="text-sm"><a onClick={() => { setIsOpenBH2(prev => !prev) }}>Những trường hợp nào không được bảo hành?</a>
                        {isOpenBH2 && (
                            <motion.div
                                initial={{
                                    opacity: 0,
                ...
                <ul
                    className={`space-y-1 mb-1 overflow-hidden transition-all duration-300 ease-in-out ${isOpenTH ? 'max-h-[1000px]' : 'max-h-0'
                        }`}
                >
                    <li className="text-sm"><a onClick={() => { setIsOpenTH1(prev => !prev) }}>Chính sách trả hàng như thế nào?</a>
                        {isOpenTH1 && (
                            <motion.div
                                initial={{
                                    opacity: 0,
                    ...
                    <li className="text-sm"><a onClick={() => { setIsOpenTH2(prev => !prev) }}>Làm sao để trả hàng?</a>
                        {isOpenTH2 && (
                            <motion.div
                                initial={{
                                    opacity: 0,
                ...
                <div className="max-w-3xl mx-auto py-4">
                    ...
                    {!isAuth ? (
                        <div className="text-center p-4 border border-gray-300 rounded-lg bg-gray-100">
                            <p className="text-lg text-gray-700 font-semibold m-0">Bạn cần đăng nhập để có thể gửi yêu cầu</p>
                        </div>
                    ) : (requests.length == 0 ? (
                        <div className="text-center p-4 border border-gray-300 rounded-lg bg-gray-100">
                            <p className="text-lg text-gray-700 font-semibold m-0">Hiện tại không có yêu cầu nào</p>
                        </div>
                    ) : (
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                            ...
                                            <div className="flex flex-row-reverse sm:flex-row justify-between sm:justify-normal items-center sm:ml-4 gap-2 sm:gap-3">
                                                ...
                                                <span
                                                    className={`inline-flex items-center px-2 py-0.5 sm:px-2.5 sm:py-0.5 rounded-full text-xs font-medium ${request.status === 'replied'
                                                        ? 'bg-green-100 text-green-800'
                                                        : 'bg-yellow-100 text-yellow-800'
                                                        }`}
                                                >
                                                    {request.status === 'replied' ? 'Đã trả lời' : 'Chờ xử lý'}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="mt-4 space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-800">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${selectedRequest.status === 'replied'
                                                    ? 'bg-green-100 text-green-800'
                                                    : 'bg-yellow-100 text-yellow-800'
                                                    }`}>
                                                    {selectedRequest.status === 'replied' ? 'Đã trả lời' : 'Chờ xử lý'}
                                                </span>
                                            </p>
                                        </div>
