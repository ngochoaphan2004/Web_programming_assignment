import { AnimatePresence, motion } from "framer-motion"; // Đã sửa từ "motion/react" thành "framer-motion"
import { FaCheckCircle, FaExclamationCircle, FaQuestionCircle } from 'react-icons/fa';

export default function ConfirmCustom({ isComfirm, isSuccessful, isError, handleCancelConfirm, handleConfirmSubmit, errorMessage }) {
    let content;
    let color;
    let icon;
    let buttonColor;
    ...
    if (isComfirm) {
        ...
        cancelButtonColor = "bg-gray-200 hover:bg-gray-300 text-gray-700";
        ...
        content = errorMessage || "Lỗi"; // Sử dụng errorMessage, fallback về "Lỗi" nếu không có
        color = "text-red-500";
